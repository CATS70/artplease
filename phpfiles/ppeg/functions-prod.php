...
/*	PayPal_Digital_Goods_Configuration::username( 'kristof.felix_api1.laposte.net' );
	PayPal_Digital_Goods_Configuration::password( 'Q8WQKNSUMAAEGBHP' );
	PayPal_Digital_Goods_Configuration::signature( 'AFcWxV21C7fd0v3bYYYRCpSSRl31AakurqigVw-wVPBFmqg5Pf6B0jtj' );*/

	PayPal_Digital_Goods_Configuration::username( 'sales_api2.art-please.com' );
	PayPal_Digital_Goods_Configuration::password( '2AQEGZLV8TF4LVES' );
	PayPal_Digital_Goods_Configuration::signature( 'AQU0e5vuZCvSg-XJploSa.sGUDlpAv34SB0IsLDCeV4534UICnEyF5pe' );
	...
	// PayPal_Digital_Goods_Configuration::return_url('http://'.$_SERVER['HTTP_HOST'].'/phpfiles/confirmpayment.php');
