...
$json_url = "$api_url/artpleasenearby/mgetgallerydata.json";
 

// jSON String for request
$json_string = "googleid=$googleid";
...
print_r (json_encode(curl_getinfo($ch))."%%%%%%%%%%%%%%%%%%%%%%%%".$result);  
curl_close($ch);

header(HTTPStatus($http_status)['error']);
//echo HTTPStatus($http_status)['error'];
//echo "$result";
